...
namespace ContosoUniversity_v2.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(ContosoUniversity_v2Context context)
        {
            _context = context;
        }
        ...
        {
            var contosoUniversity_v2Context = _context.Departments.Include(d => d.Administrator);
            return View(await contosoUniversity_v2Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ContosoUniversity_v2Context.Departments'  is null.");
            }
            var department = await _context.Departments.FindAsync(id);
            if (department != null)
            {
